    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('academic_intake_id') ? 'has-error' : '' }}">
            ...
            <select class="form-control" id="academic_intake_id" name="academic_intake_id" required>
                <option value="" style="display: none;" {{ old('academic_intake_id', optional($creditMemo)->academic_intake_id ?: '') == '' ? 'selected' : '' }} disabled selected>Select academic intake</option>
                @foreach ($academicIntakes as $key => $academicIntake)
                <option value="{{ $key }}" {{ old('academic_intake_id', optional($creditMemo)->academic_intake_id) == $key ? 'selected' : '' }}>
                    {{ $academicIntake }}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('module_id') ? 'has-error' : '' }}">
            ...
            <select class="form-control" id="module_id" name="module_id" data-control="select2">
                <option value="" style="display: none;" {{ old('module_id', optional($creditMemo)->module_id ?: '') == '' ? 'selected' : '' }} disabled selected>Select module</option>
                @foreach ($modules as $key => $module)
                <option value="{{ $key }}" {{ old('module_id', optional($creditMemo)->module_id) == $key ? 'selected' : '' }}>
                    {{ $module }}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('qualification_id') ? 'has-error' : '' }}">
            ...
            <select class="form-control" id="qualification_id" name="qualification_id" data-control="select2">
                <option value="" style="display: none;" {{ old('qualification_id', optional($creditMemo)->qualification_id ?: '') == '' ? 'selected' : '' }} disabled selected>Select qualification</option>
                @foreach ($qualifications as $key => $qualification)
                <option value="{{ $key }}" {{ old('qualification_id', optional($creditMemo)->qualification_id) == $key ? 'selected' : '' }}>
                    {{ $qualification }}
                </option>
                @endforeach
            </select>
...
<div class="row mb-5">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
            ...
            <input class="form-control" name="student_number" type="number" id="student_number" value="{{ old('student_number', optional($creditMemo)->student_number) }}">
        </div>
    </div>
</div>
...
<div class="row mb-5">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('transaction_description') ? 'has-error' : '' }}">
            ...
            <input class="form-control" name="transaction_description" type="text" id="transaction_description" value="{{ old('transaction_description', optional($creditMemo)->transaction_description) }}">
        </div>
    </div>
</div>
...
<div class="row mb-5">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
            ...
            <input class="form-control" name="amount" type="text" id="amount" value="{{ old('amount', optional($creditMemo)->amount) }}">
