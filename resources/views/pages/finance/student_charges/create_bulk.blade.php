<x-base-layout>
    <div class="col-md-6 mx-auto">
        <div class="card">
            ...
            <form method="POST" action="{{ route('finance.student_charges.storeBulk') }}" accept-charset="UTF-8" id="create_subject_fee_form" name="create_subject_fee_form" class="form-horizontal">
                <div class="card-body">
