<div id="section-to-print" onload="window.onload = function() { window.print(); }">
    ...
    <h3 style="font-family: monospace; text-align: center;"><strong>CASH-UP REPORT</strong></h3>
    ...
    <table style="width:80%;  font-family: monospace;">
        ...
        <tr class="fw-bold fs-6 text-gray-800 bg-gray-300">
            ...
            <th style="text-align: right; padding: 5px; border-bottom: 1px dashed black;">Amount (N$)</th>
        </tr>

        @foreach($payments as $payment)
        <tr>
            <td style="text-align: left; padding: 5px;">{{ $payment->payment_method }}</td>
            <td style="text-align: right; padding: 5px;">{{ number_format($payment->amount, 2, '.',',')}}</td>
        </tr>
        @endforeach
        <tr>
