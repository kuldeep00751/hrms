 <div class="card-body pt-9 pb-0">
     ...
     <div class="d-flex overflow-auto h-55px">
         <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
             <li class="nav-item">
                 <a class="nav-link text-active-primary me-6 {{ ($section === 'show') ? 'active':'' }}" href="{{ route('user_infos.user_info.show', $userInfo->id) }}">
                     Student Profile
                 </a>
             </li>

             <li class="nav-item">
                 <a class="nav-link text-active-primary me-6 {{ ($section === 'registration') ? 'active':'' }}" href="{{ route('user_infos.user_info.registration', $userInfo->id) }}">
                     Registration Information
                 </a>
             </li>

             <li class="nav-item">
                 <a class="nav-link text-active-primary me-6 {{ ($section === 'account') ? 'active':'' }}" href="{{ route('user_infos.user_info.account', $userInfo->id) }}">
                     Account
                 </a>
             </li>
         </ul>
