        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="pull-right">
                    <h4 class="mt-5 mb-5">{{ $info->first_names}} {{ $info->surname}}'s Documents</h4>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($studentDocuments->contains('required_document_id',$requiredDocument->id))
                                    <i class="fa-solid fa-circle-check text-success"></i>
                                    @else
    ...
    <div class="modal fade modal-dialog-scrollable" tabindex="-1" id="documents-upload" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content shadow-none">
                ...
                <form method="POST" action="{{ route('student_documents.student_document.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="mb-5 form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="hidden" id="required_document_id" name="required_document_id" value="">
                                <input class="form-control" type="hidden" id="user_info_id" name="user_info_id" value="{{ $info->id }}">
                            </div>
                        </div>
                        <div class="mb-5 form-group">
    ...
    <script>
        ...
        uploadButtons.forEach(function(button) {
            button.addEventListener('click', function(event) {
                ...
                let setDocumentId = document.getElementById('required_document_id');
