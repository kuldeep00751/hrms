        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="pull-right" role="group">
                    <h4 class="mt-5 mb-5">Create New Student Account</h4>
                </div>

            </div>
            <form method="POST" action="{{ route('user_infos.user_info.store') }}" accept-charset="UTF-8" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="mb-5 form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-12 mb-4">
                            <input class="form-control" name="password" type="text" id="password" value="Students@321" minlength="1" readonly>
