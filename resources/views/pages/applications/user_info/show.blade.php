<x-base-layout>
    <div class="col-md-10 mx-auto">
        ...
        <div class="card mb-5">
            <div class="card-header">
                <h6 class="fw-bolder m-0">Application Information</h6>
            </div>
            <div class="card-body pt-9 pb-0">
                <table class="table table-row-dashed">
                    ...
                    <tbody>
                        @forelse($userInfo->applications as $application)
                        <tr>
        ...
        <div class="card mb-5">
            ...
            <div class="d-flex justify-content-end p-5">
                <a href="{{ route('user_infos.user_info.edit', $userInfo->id) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-edit"></i> {{ __('Update Profile') }}</a>
            </div>
        </div>
