        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <span class="pull-right">
                    <h4 class="mt-5 mb-5">Add New Student Block</h4>
                </span>

            </div>
            <form method="POST" action="{{ route('student_blocks.student_block.store') }}" accept-charset="UTF-8" class="form-horizontal">
                <div class="card-body">
                    ...
                    {{ csrf_field() }}
                    @include ('pages.portal.student-block.form', [
                    'studentBlock' => null,
                    ])
                </div>
