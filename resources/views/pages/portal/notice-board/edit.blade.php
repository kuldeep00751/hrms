<x-base-layout>
    <div class="col-md-8 mx-auto">
        <div class="card">
            ...
            <form method="POST" action="{{ route('notice-boards.notice-board.update', $studentNoticeBoard->id) }}" accept-charset="UTF-8" class="form-horizontal" id="notice-board-form" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    'studentNoticeBoard' => $studentNoticeBoard,
                    ])
