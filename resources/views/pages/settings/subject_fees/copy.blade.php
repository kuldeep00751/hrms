        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <span class="pull-left">
                    <h4 class="mt-5 mb-5">Copy Subject Fees</h4>
                </span>
            </div>
            <form method="POST" action="{{ route('subjectFees.subjectFee.copy') }}" accept-charset="UTF-8" id="create_otherFees_form" name="create_otherFees_form" class="form-horizontal">
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="form-group">
                        ...
                        <a href="{{ route('subjectFees.subjectFee.index') }}" title="Show All Fees">
                            Cancel
                        </a>
                    </div>
