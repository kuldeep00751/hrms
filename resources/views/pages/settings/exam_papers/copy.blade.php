        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <span class="pull-left">
                    <h4 class="mt-5 mb-5">Copy Other Fees</h4>
                </span>
            </div>
            <form method="POST" action="{{ route('otherFees.otherFee.copy') }}" accept-charset="UTF-8" id="create_otherFees_form" name="create_otherFees_form" class="form-horizontal">
                <div class="card-body">
