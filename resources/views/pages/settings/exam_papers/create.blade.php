        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <span class="pull-right">
                    <h4 class="mt-5 mb-5">Create Exam Paper</h4>
                </span>
            </div>
            <form method="POST" action="{{ route('exam_papers.exam_paper.store') }}" accept-charset="UTF-8" class="form-horizontal" id="exam_papers_form">
                <div class="card-body">
