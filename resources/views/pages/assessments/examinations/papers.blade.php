        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <h3>Capture {{ $examPaper->paper_name }} marks.</h3>
                </div>
            </div>
            <form method="POST" action="{{ route('assessments.exams.store') }}" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table style="width: 50%">
                            ...
                            <tr>
                                <th class="text-start text-gray-400 fw-bold text-uppercase"><strong>Examination Type</strong></th>
                    ...
                    <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="table-responsive">
                            ...
                            <input name="exam_paper_id" type="hidden" value="{{$examPaper->id}}">
                            <input name="assessment_type_id" type="hidden" value="{{$assessmentTypeId}}">
                            ...
                            <input name="module_allocation_id" type="hidden" value="{{$lecturerModule->id}}">
                            ...
                            <table class="table table-striped table-row-bordered table-hover" id="myTable">
                                <thead>
                                    <tr class="text-start text-gray-800 fw-bold text-uppercase">
                                        ...
                                        <th class="w-25">{{ $examPaper->paper_name }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($moduleRegistrations as $moduleRegistration)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                            $mark = $examModulePaper->where('user_info_id', $moduleRegistration->user_info_id)->first();
                                            @endphp
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div class="alert alert-danger">
                                                There are no students registered or meet the minimum requirements for entering exam marks.
                                                <p><strong>Possible Causes: </strong></p>
                                                <ul>
                                                    <li>No CA marks have been entered.</li>
                                                    <li>The attendance register has not been recorded.</li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9 bg-white">
                    <a href="{{ route('assessments.exams.index') }}" class="btn btn-white btn-active-light-primary me-2">{{ __('Discard') }}</a>
