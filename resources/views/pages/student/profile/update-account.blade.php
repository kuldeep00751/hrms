<x-base-layout>
    <div class="col-md-10 mx-auto">
        ...
        <div class="card mb-5">
            <div class="card-header">
                <h6 class="fw-bolder m-0">Student Account Information</h6>
            </div>
            <div class="card-body pt-9 pb-0">
                <form method="POST" action="{{ route('user_infos.user_info.account_update', $userInfo->id) }}" accept-charset="UTF-8" class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="mb-5 form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" name="email" type="text" id="email" value="{{ old('email', $userInfo->email_address) }}" minlength="1" placeholder="Enter email here..." required autocomplete="off" autofill="off">
                            </div>
                        </div>
