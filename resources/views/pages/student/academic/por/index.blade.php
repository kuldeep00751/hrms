    ...
    <div class="card">
        ...
        <div class="card-header border-bottom border-gray-200">
            ...
            <div class="card-title">
                <h3 class="fw-bold m-0">Proof of Registrations</h3>
            </div>
            <!--end::Title-->
        </div>
        <!--end::Card header-->
                ...
                <table class="table table-row-dashed" id="kt_datatable_example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('academic.por.show', $registration->id ) }}" class="btn btn-sm btn-light btn-active-light-primary">View</a>
                            </td>
                        </tr>
                        @endforeach
                        <!--end::Table row-->
