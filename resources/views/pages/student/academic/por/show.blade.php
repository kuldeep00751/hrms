<x-base-layout>
    <div class="card">
        <div class="card-header">
            <div class="pull-left">
                <a href="{{ route('academic.proof_of_registration') }}" class="btn btn-sm btn-secondary btn-active-light-primary"><i class="fa-solid fa-chevron-left"></i> Back</a>
            </div>
            <div class="pull-right">
                <a href="{{ route('academic.por.print', $studentRegistration->id) }}" class="btn btn-sm btn-primary" target="_blank">
