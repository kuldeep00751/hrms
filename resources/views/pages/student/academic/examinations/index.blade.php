<x-base-layout>
    ...
    <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
        ...
        <div class="d-flex flex-column">
            <h4 class="mb-1 text-danger">Registration information not found</h4>
            <span>You are not registered for the current academic year</span>
        </div>
    </div>
    @else
    <div class="card">
        ...
        <div class="card-header border-bottom border-gray-200">
            ...
            <div class="card-title">
                <h3 class="fw-bold m-0">My Modules</h3>
            </div>
            <!--end::Title-->
        </div>
        <!--end::Card header-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <i>Exempted</i>
                                @else
                                <a href="{{ route('academic.examinations.view', $registration->id) }}" class="btn btn-sm btn-light btn-active-light-primary" title="Show Exam Paper Results">Exam Papers</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
