<div class="p-5 mb-5 border-dashed">
    ...
    <div class="row mb-3">
        ...
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <input type="text" name="institution[]" class="form-control form-control-lg form-control-solid" placeholder="Name of instition / university attended" data-label="Name of instition / university attended" required />
        </div>
        <!--end::Col-->
    ...
    <div class="row mb-3">
        ...
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <input type="text" name="qualification_name[]" class="form-control form-control-lg form-control-solid" placeholder="Name of qualification obtained" data-label="Qualification Name" required />
        </div>
        <!--end::Col-->
    ...
    <div class="row mb-3">
        ...
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <select name="awarded_yn[]" aria-label="{{ __('Select award status') }}" data-placeholder="{{ __('Select award status...') }}" class="form-select form-select-solid form-select-lg fw-bold" data-label="Awarded Yes/No" required>
