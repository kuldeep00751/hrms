 <div class="p-5 mb-5 border-dashed">
     ...
     <div class="row mb-3">
         ...
         <!--begin::Col-->
         <div class="col-lg-8 fv-row">
             <input type="text" name="nok_full_names[]" class="form-control form-control-lg form-control-solid" placeholder="Next of Kin Full names" data-label="Next of Kin Full names" />
         </div>
         <!--end::Col-->
     ...
     <div class="row mb-3">
         ...
         <!--begin::Col-->
         <div class="col-lg-8 fv-row">
             <input type="text" name="nok_contact_number[]" class="form-control form-control-lg form-control-solid" placeholder="Next of Kin Contact Number" data-label="Next of Kin Contact Number" />
         </div>
         <!--end::Col-->
     </div>
     <!--end::Col-->
