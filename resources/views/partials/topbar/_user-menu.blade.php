...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-5">
        <a href="{{ theme()->getPageUrl('student/profile') }}" class="menu-link px-5">
            {{ __('My Profile') }}
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="/student/academic/my_modules" class="menu-link px-5" data-bs-toggle="tooltip" data-bs-placement="left">
            <span class="menu-text">{{ __('My Modules') }}</span>
        </a>
    </div>
    <!--end::Menu item-->

    <!--begin::Menu item-->
    <div class="menu-item px-5" data-bs-toggle="tooltip" data-bs-placement="left">
        <a href="/account/statement" class="menu-link px-5">
            {{ __('My Statements') }}
        </a>
    </div>
    <!--end::Menu item-->
