            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right" role="group">
                        <a href="{{ route('leave-manages.leave-manage.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('leave-manages.leave-manage.show', $leaveManage->id ) }}" class="menu-link px-3">View</a>
                                            </div>
                                            @if($leaveManage->status != 'Approved')
                                            <div class="menu-item px-3">
                                            <a href="{{ route('leave-manages.leave-manage.edit', $leaveManage->id) }}" class="menu-link px-3">Update Leave</a>
                                            </div>

                                            <div class="menu-item px-3">
                                            <a href="{{ route('leave-manages.leave-manage.destroy', $leaveManage->id) }}" class="menu-link px-3">Delete Leave</a>
                                            </div>
                                            @endif
                                        </div>
                                    </td>
