...
<div class="row mb-5">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('leaveType_id') ? 'has-error' : '' }}">
            ...
            <input class="form-control" name="leave_type" type="hidden"  id="leave_type" value="">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function(){
        var leaveTypeSelect = document.getElementById('leaveType_id');  
        function getLeaveType() {
            let data = {
                '_token': document.getElementsByName("_token")[0].value
            }
            const url = "{{ route('get-leaveType') }}";
            ...
            .then(data => {
                leaveTypeSelect.innerHTML = data.options;
   ...
   function totaldayscount(){}
    ...
    document.getElementById('leaveType_id').addEventListener('change', function() {
        ...
        const url = "{{ route('get-available-days') }}";
