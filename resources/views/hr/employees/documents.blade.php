<x-base-layout>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-row-dashed">
                        ...
                        <tbody>
                            @foreach($employeeDocumentsdata as $requiredDocument)
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 50%">
                                    <a class="me-5 btn-outline-primary" href="#" onclick="openDocument({{$requiredDocument->id}}, '{{$requiredDocument->document_name}}')">
                                        <i class="fas fa-eye text-primary fs-4"></i>
                                    </a>
                                    <a class="me-5 btn-outline-success" href="{{ route('employees.employee.download', $requiredDocument->id) }}">
    ...
    <script>
        ...
        function openDocument(documentId, documentName) {
            ...
            window.open(`/employees/documents/display/${documentId}`, `${documentName}`, params);
        };
    </script>
</x-base-layout>