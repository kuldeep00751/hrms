...
if($lov){
$logoFileName = $lov->where('label', 'COMPANY_LOGO')->first()->value;
} else {
$logoFileName = theme()->getMediaUrlPath() . 'logos/' . $logoFileName;
}
