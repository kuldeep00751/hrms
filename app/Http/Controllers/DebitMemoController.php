...
class DebitMemoController extends Controller
{
    ...
    public function index()
    {
        ...
        $debitMemos = DebitMemo::with('userInfo', 'createdBy')->paginate(25);

        return view('pages.finance.debit_memos.index', compact('debitMemos'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.finance.debit_memos.create', compact('academicYears', 'academicIntakes', 'qualifications', 'modules'));
    }
    ...
    public function createBulk()
    {
        ...
        return view('pages.finance.debit_memos.create_bulk', compact('academicYears', 'academicIntakes', 'qualifications', 'modules'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $debitMemo = DebitMemo::create($data);
            ...
            return redirect()->route('finance.debit_memos.index')
            ->with('success_message', 'Debit Memo was successfully added.');
    ...
    public function storeBulk(Request $request)
    {
        try {
            ...
            return redirect()->route('finance.debit_memos.index')
            ->with('success_message', 'Debit Memos successfully added.');
        } catch (Exception $exception) {
    ...
    private function generateTransactionId()
    {
        ...
        $transactionId = "DM".$date . "" . $transactionId;

        $studentCharge = DebitMemo::where('transaction_id', $transactionId)->first();
