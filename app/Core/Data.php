...
class Data {
    ...
    public static function getCitizenshipStatusCodes(){
        return [
            'Namibian' => 'Namibian',
            'SADC' => 'SADC',
    ...
    public static function getAcademicProcesses(){
        return [
    ...
    public static function getFeeIncreaseTypes(){
        return [
    ...
    public static function getProgressBarColor($value){
        if(($value >= 0) && ($value < 20 )){ 
            return "danger" ; 
